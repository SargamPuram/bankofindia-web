...
//       setKeystrokeData(prev => [...prev, { key: e.key, type: 'flight', time: flightTime }]);
//     }
...
//       setTypingSpeed(username.length / elapsedSeconds);
//     }
//   };
...
//       // Log the behavioral data
//       console.log('Login attempt:', {
//         username: username.trim(),
//         location,
//         keystrokeData,
//         typingSpeed: typingSpeed.toFixed(2) + ' chars/sec',
//         timestamp: new Date().toISOString(),
//       });

//       // Here you could POST to backend
//     }, 1500);
//   };
...
//                     Typing speed: {typingSpeed.toFixed(2)} chars/sec
//                   </p>
//                 )}
//               </div>
...
//             <div className="text-xs text-muted-foreground text-center pt-4 border-t border-border">
//               <p>
//                 Your location and typing patterns are tracked for security and fraud prevention.
//               </p>
//             </div>
//           </CardContent>
//         </Card>
...
const BankingLogin: React.FC = () => {
  ...
  username: username.trim(),
  location,
  // keystrokeData, // <-- Make sure this is an array, not JSON.stringify(...)
  typingSpeed: typingSpeed.toFixed(2) + ' chars/sec',
  timestamp: new Date().toISOString(),
};
